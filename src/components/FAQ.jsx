...
const FAQ = () => {
  // Hover-based accordion; no click state needed
  const faqData = [
    {
        ...
        <div className="space-y-5">
          {faqData.map((faq, index) => (
            <div key={index} className="group bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              <div className="w-full px-6 md:px-8 py-5 text-left flex justify-between items-center cursor-pointer">
              ...
              <div className="overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] max-h-0 opacity-0 group-hover:max-h-96 group-hover:opacity-100">
